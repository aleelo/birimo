...
class Assigning_items extends Security_Controller_Plugin {
    ...
    function index($tab = "") {
      ...
      //  $this->check_module_availability("module_department");
        ...
        return $this->template->rander("aleelo_plugin\Views/assigning_items/index", $view_data);
    }
    ...
    function modal_form() {
        ...
        return $this->template->view('aleelo_plugin\Views/assigning_items/modal_form', $view_data);
    }
    ...
    public function department_employee($deparment_id)
    {
        ...
        return $this->template->rander("aleelo_plugin\Views/assigning_items/department_employee", $view_data);
    }
    ...
    function view($Deparment_id = 0, $tab = "") {
        ...
        if ($Deparment_id) {
            ...
            if ($department_info && !$department_info->is_lead) {
                ...
                return $this->template->rander("aleelo_plugin\Views/assigning_items/view", $view_data);
            } else {
                show_404();
            }
        } else {
    ...
    function add_remove_star($client_id, $type = "add") {
        if ($client_id) {
            ...
            if ($type === "add") {
                ...
                return $this->template->view('aleelo_plugin\Views/assigning_items/star/starred', $view_data);
            } else {
                $this->Clients_model->add_remove_star($client_id, $this->login_user->id, $type = "remove");
                return $this->template->view('aleelo_plugin\Views/assigning_items/star/not_starred', $view_data);
            }
        }
    }
    ...
    function show_my_starred_clients() {
        ...
        return $this->template->view('aleelo_plugin\Views/assigning_items/star/clients_list', $view_data);
    }
    ...
    function projects($client_id) {
        ...
        return $this->template->view("aleelo_plugin\Views/assigning_items/projects/index", $view_data);
    }
    ...
    function payments($client_id) {
        ...
        if ($client_id) {
            ...
            $view_data['client_id'] = clean_data($client_id);
            return $this->template->view("aleelo_plugin\Views/assigning_items/payments/index", $view_data);
        }
    }
    ...
    function tickets($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/assigning_items/tickets/index", $view_data);
        }
    }
    ...
    function invoices($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/assigning_items/invoices/index", $view_data);
        }
    }
    ...
    function estimates($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/assigning_items/estimates/estimates", $view_data);
        }
    }
    ...
    function orders($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/assigning_items/orders/orders", $view_data);
        }
    }
    ...
    function estimate_requests($client_id) {
        ...
        if ($client_id) {
            $view_data['client_id'] = clean_data($client_id);
            return $this->template->view("aleelo_plugin\Views/assigning_items/estimates/estimate_requests", $view_data);
        }
    }
    ...
    function notes($client_id) {
        ...
        if ($client_id) {
            $view_data['client_id'] = clean_data($client_id);
            return $this->template->view("aleelo_plugin\Views/assigning_items/notes/index", $view_data);
        }
    }
    ...
    function files($client_id, $view_type = "") {
        ...
        if ($view_type == "page_view") {
            ...
            return $this->template->rander("aleelo_plugin\Views/assigning_items/files/index", $view_data);
        } else {
            return $this->template->view("aleelo_plugin\Views/assigning_items/files/index", $view_data);
        }
    }
    ...
    function file_modal_form() {
        ...
        return $this->template->view('aleelo_plugin\Views/assigning_items/files/modal_form', $view_data);
    }
    ...
    function view_file($file_id = 0) {
        ...
        if ($file_info) {
            ...
            return $this->template->view("aleelo_plugin\Views/assigning_items/files/view", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function contact_profile($contact_id = 0, $tab = "") {
        ...
        if ($view_data['user_info']->user_type === "client") {
            ...
            return $this->template->rander("aleelo_plugin\Views/assigning_items/contacts/view", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function my_preferences() {
        ...
        return $this->template->view("aleelo_plugin\Views/assigning_items/contacts/my_preferences", $view_data);
    }
    ...
    function contacts($Deparment_id = 0) {
        ...
        return $this->template->view("aleelo_plugin\Views/assigning_items/contacts/index", $view_data);
    }
    ...
    function add_new_contact_modal_form() {
        ...
        return $this->template->view('aleelo_plugin\Views/assigning_items/contacts/modal_form', $view_data);
    }
    ...
    function contact_general_info_tab($contact_id = 0) {
        if ($contact_id) {
            ...
            return $this->template->view('aleelo_plugin\Views/assigning_items/contacts/contact_general_info_tab', $view_data);
        }
    }
    ...
    function company_info_tab($Deparment_id = 0) {
        if ($Deparment_id) {
            ...
            $view_data['secretary'] = array("" => " -- Choose Secretary -- ") + $this->Users_models->get_dropdown_list(array("first_name", "last_name"), "id");


            $view_data["custom_fields"] = $this->Custom_fields_model->get_combined_details("clients", $Deparment_id, $this->login_user->is_admin, $this->login_user->user_type)->getResult();

            $view_data['department_heads'] = array("" => " -- Choose Department Head -- ") + $this->Users_models->get_dropdown_list(array("first_name", "last_name"), "id");
            ...
            return $this->template->view('aleelo_plugin\Views/assigning_items/contacts/company_info_tab', $view_data);
        }
    }
    ...
    function save_contact() {
        ...
        if (!$contact_id) {
            ...
            if ($this->Users_models->is_email_exists($user_data["email"], 0, $Deparment_id)) {
    ...
    function invitation_modal() {
        ...
        $view_data["client_info"] = $this->Clients_model->get_one($client_id);
        return $this->template->view('aleelo_plugin\Views/assigning_items/contacts/invitation_modal', $view_data);
    }
    ...
    function users() {
        if ($this->login_user->user_type === "client") {
            ...
            return $this->template->rander("aleelo_plugin\Views/assigning_items/contacts/users", $view_data);
        }
    }
    ...
    function import_clients_modal_form() {
        ...
        return $this->template->view("aleelo_plugin\Views/assigning_items/import_clients_modal_form");
    }
    ...
    function gdpr() {
        $view_data["user_info"] = $this->Users_models->get_one($this->login_user->id);
        return $this->template->view("aleelo_plugin\Views/assigning_items/contacts/gdpr", $view_data);
    }
    ...
    function expenses($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/assigning_items/expenses/index", $view_data);
        }
    }
    ...
    function contracts($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/assigning_items/contracts/contracts", $view_data);
        }
    }
    ...
    function assigning_items_list() {
        ...
        return $this->template->view("aleelo_plugin\Views/assigning_items/assigning_items_list", $view_data);
    }
    ...
    function proposals($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/assigning_items/proposals/proposals", $view_data);
        }
    }
    ...
    function tasks($client_id) {
        ...
        $view_data['client_id'] = clean_data($client_id);
        return $this->template->view("aleelo_plugin\Views/assigning_items/tasks/index", $view_data);
    }
}
