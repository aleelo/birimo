...
class Invoices extends Security_Controller_Plugin
{
    ...
    function modal_form()
    {
        ...
        return $this->template->view('aleelo_plugin\Views/invoices/modal_form', $view_data);
    }
    ...
    function recurring_modal_form()
    {
        ...
        return $this->template->view('aleelo_plugin\Views/invoices/recurring_modal_form', $view_data);
    }
    ...
    function sub_invoices($recurring_invoice_id)
    {
        ...
        return $this->template->view("aleelo_plugin\Views/invoices/sub_invoices", $view_data);
    }
    ...
    //     $supplier_price = unformat_currency($this->request->getPost('supplier_price'));
    //     $supplier_quantity = unformat_currency($this->request->getPost('supplier_price'));
    ...
    public function save_item()
    {
        ...
        if ($add_new_item_to_library) {
            ...
            // ✅ Create income account and map
            $INCOME_TYPE_ID   = 11;
            $INCOME_DETAIL_ID = 83;
            $incomeName       = trim($invoice_item_title) . ' - income';
        ...
        // Sort logic
        if ($id) {
            $row = $this->db->table($this->db->prefixTable('invoice_items'))
                ->select('sort')->where('id', $id)->get()->getRow();
    ...
    function preview($invoice_id = 0, $show_close_preview = false)
    {
        if ($invoice_id) {
            ...
            return $this->template->rander("aleelo_plugin\Views/invoices/invoice_preview", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function send_invoice_modal_form($invoice_id)
    {
        ...
        if ($invoice_id) {
            ...
            return $this->template->view('aleelo_plugin\Views/invoices/send_invoice_modal_form', $view_data);
        } else {
            show_404();
        }
    }
    ...
    function get_invoice_status_bar($invoice_id = 0)
    {
        ...
        return $this->template->view('aleelo_plugin\Views/invoices/invoice_status_bar', $view_data);
    }
    ...
    function discount_modal_form()
    {
        ...
        return $this->template->view('aleelo_plugin\Views/invoices/discount_modal_form', $view_data);
    }
    ...
    function file_preview($id = "", $key = "")
    {
        if ($id) {
            ...
            return $this->template->view("aleelo_plugin\Views/invoices/file_preview", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function tasks($invoice_id)
    {
        ...
        $view_data["invoice_id"] = $invoice_id;
        return $this->template->view("aleelo_plugin\Views/invoices/tasks/index", $view_data);
    }
    ...
    function create_credit_note_modal_form($invoice_id)
    {
        ...
        return $this->template->view('aleelo_plugin\Views/invoices/create_credit_note_modal_form', $view_data);
    }
    ...
    function invoices_summary()
    {
        ...
        return $this->template->rander("aleelo_plugin\Views/invoices/reports/invoices_summary", $view_data);
    }
    ...
    function monthly_invoices_summary()
    {
        ...
        $view_data["currencies_dropdown"] = $this->_get_currencies_dropdown(false);
        return $this->template->view("aleelo_plugin\Views/invoices/reports/monthly_invoices_summary", $view_data);
    }
    ...
    function custom_invoices_summary()
    {
        ...
        $view_data["currencies_dropdown"] = $this->_get_currencies_dropdown(false);
        return $this->template->view("aleelo_plugin\Views/invoices/reports/custom_invoices_summary", $view_data);
    }
