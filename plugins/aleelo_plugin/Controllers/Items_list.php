...
class Items_list extends Security_Controller_Plugin {
    ...
    function index($tab = "") {
      ...
      //  $this->check_module_availability("module_department");
        ...
        return $this->template->rander("aleelo_plugin\Views/items_list/index", $view_data);
    }
    ...
    function modal_form() {
        ...
        return $this->template->view('aleelo_plugin\Views/items_list/modal_form', $view_data);
    }
    ...
    function save() {
        ...
        if ($save_id) {
            ...
            if(!$item_id){
               ...
               //comma $user_info = $this->db->query("SELECT u.*,j.job_title_so,j.department_id FROM rise_users u left join rise_team_member_job_info j on u.id=j.user_id where u.id = $partner?->created_by")->getRow();
    ...
    public function department_employee($deparment_id)
    {
        ...
        return $this->template->rander("aleelo_plugin\Views/items_list/department_employee", $view_data);
    }
    ...
    function view($Deparment_id = 0, $tab = "") {
        ...
        if ($Deparment_id) {
            ...
            if ($department_info && !$department_info->is_lead) {
                ...
                return $this->template->rander("aleelo_plugin\Views/items_list/view", $view_data);
            } else {
                show_404();
            }
        } else {
    ...
    function add_remove_star($client_id, $type = "add") {
        if ($client_id) {
            ...
            if ($type === "add") {
                ...
                return $this->template->view('aleelo_plugin\Views/items_list/star/starred', $view_data);
            } else {
                $this->Clients_model->add_remove_star($client_id, $this->login_user->id, $type = "remove");
                return $this->template->view('aleelo_plugin\Views/items_list/star/not_starred', $view_data);
            }
        }
    }
    ...
    function show_my_starred_clients() {
        ...
        return $this->template->view('aleelo_plugin\Views/items_list/star/clients_list', $view_data);
    }
    ...
    function projects($client_id) {
        ...
        return $this->template->view("aleelo_plugin\Views/items_list/projects/index", $view_data);
    }
    ...
    function payments($client_id) {
        ...
        if ($client_id) {
            ...
            $view_data['client_id'] = clean_data($client_id);
            return $this->template->view("aleelo_plugin\Views/items_list/payments/index", $view_data);
        }
    }
    ...
    function tickets($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/items_list/tickets/index", $view_data);
        }
    }
    ...
    function invoices($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/items_list/invoices/index", $view_data);
        }
    }
    ...
    function estimates($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/items_list/estimates/estimates", $view_data);
        }
    }
    ...
    function orders($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/items_list/orders/orders", $view_data);
        }
    }
    ...
    function estimate_requests($client_id) {
        ...
        if ($client_id) {
            $view_data['client_id'] = clean_data($client_id);
            return $this->template->view("aleelo_plugin\Views/items_list/estimates/estimate_requests", $view_data);
        }
    }
    ...
    function notes($client_id) {
        ...
        if ($client_id) {
            $view_data['client_id'] = clean_data($client_id);
            return $this->template->view("aleelo_plugin\Views/items_list/notes/index", $view_data);
        }
    }
    ...
    function files($client_id, $view_type = "") {
        ...
        if ($view_type == "page_view") {
            ...
            return $this->template->rander("aleelo_plugin\Views/items_list/files/index", $view_data);
        } else {
            return $this->template->view("aleelo_plugin\Views/items_list/files/index", $view_data);
        }
    }
    ...
    function file_modal_form() {
        ...
        return $this->template->view('aleelo_plugin\Views/items_list/files/modal_form', $view_data);
    }
    ...
    function view_file($file_id = 0) {
        ...
        if ($file_info) {
            ...
            return $this->template->view("aleelo_plugin\Views/items_list/files/view", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function contact_profile($contact_id = 0, $tab = "") {
        ...
        if ($view_data['user_info']->user_type === "client") {
            ...
            return $this->template->rander("aleelo_plugin\Views/items_list/contacts/view", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function my_preferences() {
        ...
        return $this->template->view("aleelo_plugin\Views/items_list/contacts/my_preferences", $view_data);
    }
    ...
    function contacts($Deparment_id = 0) {
        ...
        return $this->template->view("aleelo_plugin\Views/items_list/contacts/index", $view_data);
    }
    ...
    function add_new_contact_modal_form() {
        ...
        return $this->template->view('aleelo_plugin\Views/items_list/contacts/modal_form', $view_data);
    }
    ...
    function contact_general_info_tab($contact_id = 0) {
        if ($contact_id) {
            ...
            return $this->template->view('aleelo_plugin\Views/items_list/contacts/contact_general_info_tab', $view_data);
        }
    }
    ...
    function company_info_tab($Deparment_id = 0) {
        if ($Deparment_id) {
            ...
            return $this->template->view('aleelo_plugin\Views/items_list/contacts/company_info_tab', $view_data);
        }
    }
    ...
    function invitation_modal() {
        ...
        $view_data["client_info"] = $this->Clients_model->get_one($client_id);
        return $this->template->view('aleelo_plugin\Views/items_list/contacts/invitation_modal', $view_data);
    }
    ...
    function users() {
        if ($this->login_user->user_type === "client") {
            ...
            return $this->template->rander("aleelo_plugin\Views/items_list/contacts/users", $view_data);
        }
    }
    ...
    function import_clients_modal_form() {
        ...
        return $this->template->view("aleelo_plugin\Views/items_list/import_clients_modal_form");
    }
    ...
    function gdpr() {
        $view_data["user_info"] = $this->Users_models->get_one($this->login_user->id);
        return $this->template->view("aleelo_plugin\Views/items_list/contacts/gdpr", $view_data);
    }
    ...
    function expenses($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/items_list/expenses/index", $view_data);
        }
    }
    ...
    function contracts($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/items_list/contracts/contracts", $view_data);
        }
    }
    ...
    function items_list_list() {
        ...
        return $this->template->view("aleelo_plugin\Views/items_list/items_list_list", $view_data);
    }
    ...
    function proposals($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/items_list/proposals/proposals", $view_data);
        }
    }
    ...
    function tasks($client_id) {
        ...
        $view_data['client_id'] = clean_data($client_id);
        return $this->template->view("aleelo_plugin\Views/items_list/tasks/index", $view_data);
    }
}
