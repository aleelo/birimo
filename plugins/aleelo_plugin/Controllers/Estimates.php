...
class Estimates extends Security_Controller_Plugin {
    ...
    function index() {
        ...
        if ($this->login_user->user_type === "staff") {
            ...
            return $this->template->rander("aleelo_plugin\Views/clients/estimates/client_portal", $view_data);
        }
    }
...
function update_estimate_status($estimate_id, $status, $is_modal = false) {
    ...
    function view($estimate_id = 0) {
        ...
        if ($estimate_id) {
            ...
            if ($view_data) {
                ...
                return $this->template->rander("aleelo_plugin\Views/estimates/view", $view_data);
            } else {
                show_404();
            }
        }
    ...
    private function _get_estimate_total_view($estimate_id = 0) {
        ...
        $view_data["is_estimate_editable"] = $this->_is_estimate_editable($estimate_id);
        return $this->template->view('aleelo_plugin\Views/estimates/estimate_total_section', $view_data, true);
    }
    ...
    function discount_modal_form() {
        ...
        return $this->template->view('aleelo_plugin\Views/estimates/discount_modal_form', $view_data);
    }
    ...
    function preview($estimate_id = 0, $show_close_preview = false) {
        ...
        if ($estimate_id) {
            ...
            return $this->template->rander("aleelo_plugin\Views/estimates/estimate_preview", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function send_estimate_modal_form($estimate_id) {
        ...
        if ($estimate_id) {
            ...
            return $this->template->view('aleelo_plugin\Views/estimates/send_estimate_modal_form', $view_data);
        } else {
            show_404();
        }
    }
    ...
    function tasks($estimate_id) {
        ...
        return $this->template->view("aleelo_plugin\Views/estimates/tasks/index", $view_data);
    }
