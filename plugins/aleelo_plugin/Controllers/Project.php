...
class Project extends Security_Controller_Plugin {
    ...
    function modal_form() {
        ...
        return $this->template->view('aleelo_plugin\Views/projects/modal_form', $view_data);
    }
    ...
    function clone_project_modal_form() {
        ...
        return $this->template->view('aleelo_plugin\Views/projects/clone_project_modal_form', $view_data);
    }
    ...
    private function _make_row($data, $custom_fields) {
        ...
        $title = anchor(get_uri("project/view/" . $data->id), $data->title);
        if ($data->labels_list) {
        ...
        if ($this->can_edit_projects($data->id)) {
            $optoins .= modal_anchor(get_uri("project/modal_form"), "<i data-feather='edit' class='icon-16'></i>", array("class" => "edit", "title" => app_lang('edit_project'), "data-post-id" => $data->id));
        }

        if ($this->can_delete_projects($data->id)) {
            $optoins .= js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_project'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("project/delete"), "data-action" => "delete-confirmation"));
        }
        ...
        $row_data = array(
            anchor(get_uri("project/view/" . $data->id), $data->id),
            $data->company_nm,
            $title,
            $client_name,
            $price,
...
if ($user_company_id != 0 && $project_info->company_id != $user_company_id) {
    app_redirect("project/all_projects");
        ...
        return $this->template->rander("aleelo_plugin\Views/projects/details_view", $view_data);
    }
    ...
    function show_my_starred_projects() {
        ...
        return $this->template->view('aleelo_plugin\Views/projects/star/projects_list', $view_data);
    }
    ...
    function overview($project_id) {
        ...
        return $this->template->view('aleelo_plugin\Views/projects/overview', $view_data);
    }
    ...
    function add_remove_star($project_id, $type = "add") {
        if ($project_id) {
            ...
            if ($type === "add") {
                ...
                return $this->template->view('aleelo_plugin\Views/projects/star/starred', $view_data);
            } else {
                $this->Projects_model->add_remove_star($project_id, $this->login_user->id, $type = "remove");
                return $this->template->view('aleelo_plugin\Views/projects/star/not_starred', $view_data);
            }
        }
    }
    ...
    function overview_for_client($project_id) {
        ...
        if ($this->login_user->user_type === "client") {
            ...
            return $this->template->view('aleelo_plugin\Views/projects/overview_for_client', $view_data);
        }
    }
    ...
    function project_member_modal_form() {
        ...
        return $this->template->view('aleelo_plugin\Views/projects/project_members/modal_form', $view_data);
    }
    ...
    private function _make_project_member_row($data, $can_send_message_to_client = false) {
        ...
        if ($this->can_add_remove_project_members()) {
            $delete_link = js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_member'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("project/delete_project_member"), "data-action" => "delete"));
    ...
    function stop_timer_modal_form($project_id) {
        ...
        if ($project_id) {
            ...
            return $this->template->view('aleelo_plugin\Views/projects/timesheets/stop_timer_modal_form', $view_data);
        }
    }
    ...
    function timer($project_id, $timer_status = "start") {
        ...
        if ($timer_status === "start") {
            if ($this->request->getPost("task_timer")) {
                echo modal_anchor(get_uri("project/stop_timer_modal_form/" . $project_id), "<i data-feather='clock' class='icon-16'></i> " . app_lang('stop_timer'), array("class" => "btn btn-danger", "title" => app_lang('stop_timer'), "data-post-task_id" => $task_id));
            } else {
                $view_data = $this->_get_project_info_data($project_id);
                return $this->template->view('aleelo_plugin\Views/projects/project_timer', $view_data);
            }
        } else {
    ...
    function timesheets($project_id) {
        ...
        return $this->template->view("aleelo_plugin\Views/projects/timesheets/index", $view_data);
    }
    ...
    function timelog_modal_form() {
        ...
        return $this->template->view('aleelo_plugin\Views/projects/timesheets/modal_form', $view_data);
    }
    ...
    private function _make_timesheet_row($data, $custom_fields) {
        ...
        $project_title = anchor(get_uri("project/view/" . $data->project_id), $data->project_title);
        ...
        $options = modal_anchor(get_uri("project/timelog_modal_form"), "<i data-feather='edit' class='icon-16'></i>", array("class" => "edit", "title" => app_lang('edit_timelog'), "data-post-id" => $data->id))
                . js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_timelog'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("project/delete_timelog"), "data-action" => "delete"));
    ...
    function timesheet_summary($project_id) {
        ...
        return $this->template->view("aleelo_plugin\Views/projects/timesheets/summary_list", $view_data);
    }
    ...
    function all_timesheets() {
        ...
        return $this->template->view("aleelo_plugin\Views/projects/timesheets/all_timesheets", $view_data);
    }
    ...
    function all_timesheet_summary() {
        ...
        return $this->template->view("aleelo_plugin\Views/projects/timesheets/all_summary_list", $view_data);
    }
    ...
    function milestones($project_id) {
        ...
        return $this->template->view("aleelo_plugin\Views/projects/milestones/index", $view_data);
    }
    ...
    function milestone_modal_form() {
        ...
        return $this->template->view('aleelo_plugin\Views/projects/milestones/modal_form', $view_data);
    }
    ...
    private function _make_milestone_row($data) {
        ...
        $optoins = "";
        if ($this->can_edit_milestones()) {
            $optoins .= modal_anchor(get_uri("project/milestone_modal_form"), "<i data-feather='edit' class='icon-16'></i>", array("class" => "edit", "title" => app_lang('edit_milestone'), "data-post-id" => $data->id));
        }

        if ($this->can_delete_milestones()) {
            $optoins .= js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_milestone'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("project/delete_milestone"), "data-action" => "delete"));
        }
    ...
    function comments($project_id) {
        ...
        $view_data['project_id'] = $project_id;
        return $this->template->view("aleelo_plugin\Views/projects/comments/index", $view_data);
    }
    ...
    function save_comment() {
        ...
        if ($save_id) {
            ...
            if ($this->request->getPost("reload_list")) {
                $view_data['comments'] = $this->Project_comments_model->get_details($options)->getResult();
                $response_data = $this->template->view("aleelo_plugin\Views/projects/comments/comment_list", $view_data);
            }
    ...
    function view_comment_replies($comment_id) {
        ...
        return $this->template->view("aleelo_plugin\Views/projects/comments/reply_list", $view_data);
    }
    ...
    function comment_reply_form($comment_id, $type = "project", $type_id = 0) {
        ...
        return $this->template->view("aleelo_plugin\Views/projects/comments/reply_form", $view_data);
    }
    ...
    function files($project_id) {
        ...
        return $this->template->view("aleelo_plugin\Views/projects/files/index", $view_data);
    }
    ...
    function view_file($file_id = 0) {
        ...
        if ($file_info) {
            ...
            $view_data['current_url'] = get_uri("project/view_file/" . $file_id);
            return $this->template->view("aleelo_plugin\Views/projects/files/view", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function file_modal_form() {
        ...
        return $this->template->view('aleelo_plugin\Views/projects/files/modal_form', $view_data);
    }
    ...
    private function _make_file_row($data, $custom_fields) {
        ...
        $description = "<div class='float-start text-wrap'>" .
                js_anchor(remove_file_prefix($data->file_name), array('title' => "", "data-toggle" => "app-modal", "data-sidebar" => "1", "data-url" => get_uri("project/view_file/" . $data->id)));
        ...
        $options = anchor(get_uri("project/download_file/" . $data->id), "<i data-feather='download-cloud' class='icon-16'></i>", array("title" => app_lang("download")));
        if ($this->can_add_files()) {
            $options .= modal_anchor(get_uri("project/file_modal_form"), "<i data-feather='edit' class='icon-16'></i>", array("class" => "edit", "title" => app_lang('edit_files'), "data-post-id" => $data->id));
        }
        if ($this->can_delete_files($data->uploaded_by)) {
            $options .= js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_file'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("project/delete_file"), "data-action" => "delete-confirmation"));
        }
    ...
    function notes($project_id) {
        ...
        $this->access_only_team_members();
        $view_data['project_id'] = $project_id;
        return $this->template->view("aleelo_plugin\Views/projects/notes/index", $view_data);
    }
    ...
    function history($offset = 0, $log_for = "", $log_for_id = "", $log_type = "", $log_type_id = "") {
        ...
        return $this->template->view("aleelo_plugin\Views/projects/history/index", $view_data);
    }
    ...
    function members($project_id = 0) {
        ...
        $this->access_only_team_members();
        $view_data['project_id'] = $project_id;
        return $this->template->view("aleelo_plugin\Views/projects/project_members/index", $view_data);
    }
    ...
    function payments($project_id) {
        ...
        if ($project_id) {
            ...
            $view_data['project_id'] = $project_id;
            return $this->template->view("aleelo_plugin\Views/projects/payments/index", $view_data);
        }
    }
    ...
    function invoices($project_id, $client_id = 0) {
        ...
        if ($project_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/projects/invoices/index", $view_data);
        }
    }
    ...
    function expenses($project_id) {
        ...
        if ($project_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/projects/expenses/index", $view_data);
        }
    }
    ...
    function timesheet_chart($project_id = 0) {
        ...
        return $this->template->view("aleelo_plugin\Views/projects/timesheets/timesheet_chart", $view_data);
    }
    ...
    function like_comment($comment_id = 0) {
        if ($comment_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/projects/comments/like_comment", array("comment" => $comment));
        }
    }
    ...
    function contracts($project_id) {
        ...
        if ($project_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/projects/contracts/index", $view_data);
        }
    }
    ...
    function pin_comment($comment_id = 0) {
        if ($comment_id) {
            ...
            if ($save_id) {
                ...
                $save_data = $this->template->view("aleelo_plugin\Views/projects/comments/pinned_comments", array("pinned_comments" => $pinned_comments));
    ...
    function tickets($project_id) {
        ...
        if ($project_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/projects/tickets/index", $view_data);
        }
    }
    ...
    function file_category($project_id = 0) {
        ...
        $view_data["project_id"] = $project_id;
        $view_data['can_add_files'] = $this->can_add_files();
        return $this->template->view("aleelo_plugin\Views/projects/files/category/index", $view_data);
    }
    ...
    private function _make_file_category_row($data, $project_id = 0) {
        $options = "";
        if ($this->can_add_files()) {
            $options .= modal_anchor(get_uri("project/file_category_modal_form"), "<i data-feather='edit' class='icon-16'></i>", array("class" => "edit", "title" => app_lang('edit_category'), "data-post-id" => $data->id, "data-post-project_id" => $project_id));
        }

        if ($this->can_delete_files()) {
            $options .= js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_category'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("project/delete_file_category"), "data-action" => "delete", "data-post-project_id" => $project_id));
        }
    ...
    function file_category_modal_form() {
        ...
        $view_data['project_id'] = $project_id;
        return $this->template->view('aleelo_plugin\Views/projects/files/category/modal_form', $view_data);
    }
    ...
    function show_my_open_timers() {
        ...
        return $this->template->view("aleelo_plugin\Views/projects/open_timers", $view_data);
    }
    ...
    function team_members_summary() {
        ...
        return $this->template->rander("aleelo_plugin\Views/projects/reports/team_members_summary", $view_data);
    }
    ...
    function clients_summary() {
        ...
        return $this->template->view("aleelo_plugin\Views/projects/reports/clints_summary", $view_data);
    }
