...
class Tasks extends Security_Controller_Plugin {
 ...
 $view_data['has_all_permission'] = ( $this->login_user->is_admin || 
        ...
        return $this->template->view('aleelo_plugin\Views/tasks/modal_form', $view_data);
    }
    ...
    function view($task_id = 0) {
        ...
        if ($view_type == "details") {
            return $this->template->rander('aleelo_plugin\Views/tasks/view', $view_data);
        } else {
            return $this->template->view('aleelo_plugin\Views/tasks/view', $view_data);
        }
    }
    ...
    function project_tasks($project_id) {
        ...
        return $this->template->view("aleelo_plugin\Views/projects/tasks/index", $view_data);
    }
    ...
    function project_tasks_kanban($project_id) {
        ...
        return $this->template->view("aleelo_plugin\Views/projects/tasks/kanban/project_tasks", $view_data);
    }
    ...
    function all_tasks($tab = "", $status_id = 0, $priority_id = 0, $type = "", $deadline = "") {
        ...
        return $this->template->rander("aleelo_plugin\Views/tasks/all_tasks", $view_data);
    }
    ...
    function all_tasks_kanban() {
        ...
        return $this->template->rander("aleelo_plugin\Views/tasks/kanban/all_tasks", $view_data);
    }
    ...
    function all_tasks_kanban_data() {
        ...
        if ($column_id) {
            ...
            return $this->template->view('aleelo_plugin\Views/tasks/kanban/kanban_column_items', $view_data);
        } else {
            ...
            return $this->template->view('aleelo_plugin\Views/tasks/kanban/kanban_view', $view_data);
        }
    }
    ...
    function batch_update_modal_form($task_ids = "") {
        ...
        if ($task_ids && $project_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/tasks/batch_update/modal_form", $view_data);
        } else {
            show_404();
        }
    }
