...
class Client extends Security_Controller_Plugin {
    ...
    function index($tab = "") {
        ...
        return $this->template->rander("aleelo_plugin\Views/clients/index", $view_data);
    }
    ...
    function modal_form() {
        ...
        ($this->login_user->user_type === "staff" &&  $this->login_user->company_access ==="all");
...
$edit = "";
    ...
    function view($client_id = 0, $tab = "", $folder_id = 0) {
        ...
        if ($client_id) {
            ...
            if ($client_info && !$client_info->is_lead) {
                ...
                return $this->template->rander("aleelo_plugin\Views/clients/view", $view_data);
            } else {
                show_404();
            }
        } else {
    ...
    function add_remove_star($client_id, $type = "add") {
        ...
        if ($client_id) {
            ...
            if ($type === "add") {
                ...
                return $this->template->view('aleelo_plugin\Views/clients/star/starred', $view_data);
            } else {
                $this->Clients_model->add_remove_star($client_id, $this->login_user->id, $type = "remove");
                return $this->template->view('aleelo_plugin\Views/clients/star/not_starred', $view_data);
            }
        }
    }
    ...
    function show_my_starred_clients() {
        ...
        return $this->template->view('aleelo_plugin\Views/clients/star/clients_list', $view_data);
    }
    ...
    function projects($client_id) {
        ...
        return $this->template->view("aleelo_plugin\Views/clients/projects/index", $view_data);
    }
    ...
    function payments($client_id) {
        ...
        if ($client_id) {
            ...
            $view_data['client_id'] = clean_data($client_id);
            return $this->template->view("aleelo_plugin\Views/clients/payments/index", $view_data);
        }
    }
    ...
    function tickets($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/clients/tickets/index", $view_data);
        }
    }
    ...
    function invoices($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/clients/invoices/index", $view_data);
        }
    }
    ...
    function orders($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/clients/orders/orders", $view_data);
        }
    }
    ...
    function estimate_requests($client_id) {
        ...
        if ($client_id) {
            $view_data['client_id'] = clean_data($client_id);
            return $this->template->view("aleelo_plugin\Views/clients/estimates/estimate_requests", $view_data);
        }
    }
    ...
    function notes($client_id) {
        ...
        if ($client_id) {
            $view_data['client_id'] = clean_data($client_id);
            return $this->template->view("aleelo_plugin\Views/clients/notes/index", $view_data);
        }
    }
    ...
    function files($client_id, $view_type = "", $folder_id = 0) {
        ...
        if ($view_type == "page_view") {
            ...
            return $this->template->rander("aleelo_plugin\Views/clients/files/index", $view_data);
        } else {
            return $this->template->view("aleelo_plugin\Views/clients/files/index", $view_data);
        }
    }
    ...
    function file_modal_form() {
        ...
        return $this->template->view('aleelo_plugin\Views/clients/files/modal_form', $view_data);
    }
    ...
    private function _make_file_row($data) {
        ...
        $options = anchor(get_uri("client/download_file/" . $data->id), "<i data-feather='download-cloud' class='icon-16'></i>", array("title" => app_lang("download")));
    ...
    function view_file($file_id = 0) {
        ...
        if ($file_info) {
            ...
            return $this->template->view("aleelo_plugin\Views/clients/files/view", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function contact_profile($contact_id = 0, $tab = "") {
        ...
        if ($view_data['user_info']->user_type === "client") {
            ...
            return $this->template->rander("aleelo_plugin\Views/clients/contacts/view", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function my_preferences() {
        ...
        return $this->template->view("aleelo_plugin\Views/clients/contacts/my_preferences", $view_data);
    }
    ...
    function add_new_contact_modal_form() {
        ...
        return $this->template->view('aleelo_plugin\Views/clients/contacts/modal_form', $view_data);
    }
    ...
    function company_info_tab($client_id = 0) {
        ...
        if ($client_id) {
            ...
            return $this->template->view('aleelo_plugin\Views/clients/contacts/company_info_tab', $view_data);
        }
    }
    ...
    private function _make_contact_row($data, $custom_fields, $hide_primary_contact_label = false) {
        ...
        $contact_link = anchor(get_uri("client/contact_profile/" . $data->id), $full_name . $primary_contact) . $removal_request_pending;
        if ($this->login_user->user_type === "client") {
        ...
        $contact_permissions = modal_anchor(get_uri("client/contact_permissions_modal_form"), "<i data-feather='key' class='icon-16'></i>", array("class" => "edit", "title" => app_lang('user_permissions'), "data-post-id" => $data->id));

        $row_data = array(
            $user_avatar,
            $contact_link,
            anchor(get_uri("client/view/" . $data->client_id), $client_info->company_name),
            $data->job_title,
            $data->email,
    ...
    function invitation_modal() {
        ...
        return $this->template->view('aleelo_plugin\Views/clients/contacts/invitation_modal', $view_data);
    }
    ...
    function users() {
        if ($this->login_user->user_type === "client") {
            ...
            return $this->template->rander("aleelo_plugin\Views/clients/contacts/users", $view_data);
        }
    }
    ...
    function request_my_account_removal() {
        if (get_setting("enable_gdpr") && get_setting("clients_can_request_account_removal")) {
            ...
            app_redirect("client/contact_profile/$user_id/gdpr");
        }
    }
    ...
    function expenses($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/clients/expenses/index", $view_data);
        }
    }
    ...
    function contracts($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/clients/contracts/contracts", $view_data);
        }
    }
    ...
    function clients_list() {
        ...
        return $this->template->view("aleelo_plugin\Views/clients/clients_list", $view_data);
    }
    ...
    function proposals($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/clients/proposals/proposals", $view_data);
        }
    }
    ...
    function subscriptions($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("aleelo_plugin\Views/clients/subscriptions/index", $view_data);
        }
    }
    ...
    function contact_permissions($contact_id) {
        ...
        $view_data['label_column'] = "col-md-2";
        $view_data['field_column'] = "col-md-10";
        return $this->template->view("aleelo_plugin\Views/clients/contacts/contact_permissions", $view_data);
    }
    ...
    function contact_permissions_modal_form() {
        ...
        return $this->template->view('aleelo_plugin\Views/clients/contacts/contact_permissions_modal_form', $view_data);
    }
    ...
    private function _folder_config() {
        ...
        $info->add_files_modal_url = get_uri("client/file_modal_form");

        $info->file_preview_url = get_uri("client/view_file");
