...
<div class="card">
    <div class="tab-title clearfix">
        <h4><?php echo app_lang('expense_payments'); ?></h4>
            ...
            <?php echo modal_anchor(get_uri("expense_payments_emp/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_expense_payment'), array("class" => "btn btn-default", "title" => app_lang('add_expense_payment'), "data-post-invoice_id" => $expense_id)); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#expense-payment-table").appTable({
            source: '<?= get_uri("expense_payments_emp/datatable/" . ($expense_id ?? 0)); ?>',
            order: [[0, "desc"]],
            columns: [
