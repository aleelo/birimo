<?php echo form_open(get_uri("expense_payments_emp/save"), array("id" => "expense-payment-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        if (fixedExpenseId) {
            $.ajax({
                url: "<?php echo get_uri('expense_payments_emp/get_invoice_payment_amount_suggestion'); ?>/" + fixedExpenseId,
                cache: false,
                type: 'POST',
                dataType: "json",
        ...
        $("#expense_id").on("change", function() {
            ...
            if (expense_id) {
                $.ajax({
                    url: "<?php echo get_uri('expense_payments_emp/get_invoice_payment_amount_suggestion'); ?>/" + expense_id,
                    cache: false,
                    type: 'POST',
                    dataType: "json",
                    success: function(response) {
