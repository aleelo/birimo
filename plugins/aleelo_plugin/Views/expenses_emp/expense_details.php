                    ...
                    <div role="tabpanel" class="tab-pane fade active show" id="expenses-details-section">
                        ...
                        <?php if ($expense_info->recurring_expense_id) { ?>
                            <div class="col-md-12 mb15">
                                ...
                                <?php
                                echo modal_anchor(get_uri("expenses_emp/expense_details"), app_lang("original_expense"), array("title" => app_lang("expense_details"), "data-post-id" => $expense_info->recurring_expense_id));
                                ?>
                            </div>
                        <?php } ?>
...
<div class="modal-footer">
    <?php
    echo modal_anchor(get_uri("expenses_emp/modal_form"), "<i data-feather='copy' class='icon-16'></i> " . app_lang('clone_expense'), array("class" => "btn btn-default float-start", "data-post-is_clone" => true, "data-post-id" => $expense_info->id, "title" => app_lang('clone_expense')));
    echo modal_anchor(get_uri("expenses_emp/modal_form"), "<i data-feather='edit' class='icon-16'></i> " . app_lang('edit_expense'), array("class" => "btn btn-default", "data-post-id" => $expense_info->id, "title" => app_lang('edit_expense')));
    ?>
