<?php echo form_open(get_uri("expenses_emp/save_expense_from_excel_file"), array("id" => "import-expense-form", "class" => "general-form", "role" => "form")); ?>
    ...
    <div class="container-fluid">
        <div id="upload-area">
            ...
            echo view("includes/multi_file_uploader", array(
                ...
                "validation_url" => get_uri("expenses_emp/validate_import_expenses_file"),
                "max_files" => 1,
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $nextButton.click(function () {
            ...
            $.ajax({
                url: "<?php echo get_uri('expenses_emp/validate_import_expenses_file_data') ?>",
                type: 'POST',
                dataType: 'json',
