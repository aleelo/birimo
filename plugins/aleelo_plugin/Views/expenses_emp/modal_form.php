<?php echo form_open(get_uri("expenses_emp/save"), array("id" => "expense-form", "class" => "general-form", "role" => "form")); ?>
                    ...
                    <div class="row">
                        ...
                        <div class=" col-md-9">
                            ...
                            echo form_input(array(
                                ...
                                "class" => "form-control",
                                "data-source_url" => get_uri("expenses_emp/get_projects_dropdown"),
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#expense_client_id").on("change", function() {
            ...
            $.ajax({
                url: "<?php echo get_uri('expenses_emp/get_projects_dropdown'); ?>",
                type: "POST",
                data: {
        ...
        $("#expense_project_id").on("change", function() {
            ...
            $.ajax({
                url: "<?php echo get_uri('expenses_emp/get_clients_dropdown'); ?>",
                type: "POST",
                data: {
