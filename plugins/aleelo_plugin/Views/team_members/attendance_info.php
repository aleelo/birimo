...
?>">
    <ul id="team-member-attendance-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white rounded-0 title" role="tablist">
        ...
        <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("team_member/weekly_attendance/"); ?>" data-bs-target="#team_member-weekly-attendance"><?php echo app_lang('weekly'); ?></a></li>    
        <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("team_member/custom_range_attendance/"); ?>" data-bs-target="#team_member-custom-range-attendance"><?php echo app_lang('custom'); ?></a></li>    
        <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("team_member/attendance_summary/" . $user_id); ?>" data-bs-target="#team_member-attendance-summary"><?php echo app_lang('summary'); ?></a></li>   
