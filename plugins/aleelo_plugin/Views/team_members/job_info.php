<div class="tab-content">
    <?php echo form_open(get_uri("team_member/save_job_info/"), array("id" => "job-info-form", "class" => "general-form dashed-row white", "role" => "form")); ?>
    ...
    $(document).ready(function () {
        $("#job-info-form").appForm({
            ...
            onSuccess: function (result) {
                ...
                window.location.href = "<?php echo get_uri("team_member/view/" . $user_id); ?>" + "/job_info";
            }
        });
