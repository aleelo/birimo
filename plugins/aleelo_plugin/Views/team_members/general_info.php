<div class="tab-content">
    <?php echo form_open(get_uri("team_member/save_general_info/" . $user_info->id), array("id" => "general-info-form", "class" => "general-form dashed-row white", "role" => "form")); ?>
    ...
    $(document).ready(function () {
        $("#general-info-form").appForm({
            ...
            onSuccess: function (result) {
                ...
                setTimeout(function () {
                    window.location.href = "<?php echo get_uri("team_member/view/" . $user_info->id); ?>" + "/general";
                }, 500);
            }
        });
