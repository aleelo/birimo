<div class="card border-top-0 rounded-top-0">
    <div class="tab-title clearfix">
        ...
        <div class="title-button-group">
            <?php
            echo modal_anchor(get_uri("team_member/file_modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_files'), array("class" => "btn btn-default", "title" => app_lang('add_files'), "data-post-user_id" => $user_id));
            ?>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#team-member-file-table").appTable({
            source: '<?php echo_uri("team_member/files_list_data/" . $user_id) ?>',
            order: [[0, "desc"]],
            columns: [
