...
<div id="page-content" class="page-wrapper clearfix grid-button">
    <div class="card clearfix">
        <ul id="project-reports-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white inner" role="tablist">
            ...
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("project/clients_summary"); ?>" data-bs-target="#clints-summary-tab"><?php echo app_lang('clients_summary'); ?></a></li>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#team-members-summary").appTable({
            source: '<?php echo_uri("project/team_members_summary_data") ?>',
