                ...
                <div class="project-title-section">
                    <div class="page-title no-bg clearfix mb5 no-border">
                            ...
                            <h1 class="pl0">
                                ...
                                <?php if (!(get_setting("disable_access_favorite_project_option_for_clients") && $login_user->user_type == "client")) { ?>
                                    <span id="star-mark">
                                        <?php
                                        if ($is_starred) {
                                            echo view('aleelo_plugin\Views/projects/star/starred', array("project_id" => $project_info->id));
                                        } else {
                                            echo view('aleelo_plugin\Views/projects/star/not_starred', array("project_id" => $project_info->id));
                                        }
                                        ?>
                                    </span>
                                <?php } ?>
                        ...
                        <div class="project-title-button-group-section">
                            <div class="title-button-group mr0" id="project-timer-box">
                                <?php echo view("aleelo_plugin\Views/projects/project_title_buttons"); ?>
                            </div>
                        </div>
                    </div>
                    <ul id="project-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs rounded classic mb20 scrollable-tabs border-white" role="tablist">
                        ...
                        if ($login_user->user_type === "staff") {
                            //default tab order
                            $project_tabs = array(
                                "overview" => "project/overview/" . $project_info->id,
                            ...
                            if ($show_invoice_info && $project_info->project_type === "client_project") {
                                ...
                                $project_tabs["payments"] = "project/payments/" . $project_info->id;
                            }

                            if ($show_expense_info) {
                                $project_tabs["expenses"] = "project/expenses/" . $project_info->id;
                                // print_r($project_info->id);die;
                            }

                            if ($show_contract_info && $project_info->project_type === "client_project") {
                                $project_tabs["contracts"] = "project/contracts/" . $project_info->id;
                            }

                            if ($show_ticket_info && $project_info->project_type === "client_project") {
                                $project_tabs["tickets"] = "project/tickets/" . $project_info->id;
                            }
                            ...
                            //default tab order
                            $project_tabs = array(
                                "overview" => "project/overview_for_client/" . $project_info->id
                            );
                            ...
                            if (get_setting("module_invoice")) {
                                ...
                                if (!$left_menu || in_array("invoices", array_column($left_menu, "name"))) {
                                    $project_tabs["invoices"] = "project/invoices/" . $project_info->id . "/" . $login_user->client_id;
                                }
                            }
