<?php echo form_open(get_uri("project/save_timelog"), array("id" => "timelog-form", "class" => "general-form", "role" => "form")); ?>
    ...
    $(document).ready(function () {
        ...
        $("#project_id").select2().on("change", function () {
            ...
            if (projectId) {
                ...
                $.ajax({
                    url: "<?php echo get_uri('project/get_all_related_data_of_selected_project_for_timelog') ?>" + "/" + projectId,
                    dataType: "json",
