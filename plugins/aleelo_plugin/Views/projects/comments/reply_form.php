<?php echo form_open(get_uri("project/save_comment"), array("class" => "reply-form general-form", "role" => "form")); ?>
<?php
$parent_id = 0;
if (isset($comment_id)) {
    ...
    <div class="w-100">
        <div id="<?php echo "reply-dropzone-" . $parent_id; ?>"  class="post-dropzone form-group">
            ...
            echo form_textarea(array(
                ...
                "data-mention" => true,
                "data-mention-source" => get_uri("project/get_member_suggestion_to_mention"),
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.comment_reply_description').appMention({
            source: "<?php echo_uri("project/get_member_suggestion_to_mention"); ?>",
        ...
        var uploadUrl = "<?php echo get_uri("project/upload_file"); ?>";
        var validationUrl = "<?php echo get_uri("project/validate_project_file"); ?>";
