    ...
    <div class="rounded-bottom pt-2">
        <div class="box">
            <div class="box-content">
                <a href="<?php echo get_uri('project/all_projects/1'); ?>" class="text-default">
            ...
            <div class="box-content">
                <a href="<?php echo get_uri('project/all_projects/2'); ?>" class="text-default">
                    <div class="pt-3 pb10 text-center">
                        <div class="b-r">
            ...
            <div class="box-content">
                <a href="<?php echo get_uri('project/all_projects/3'); ?>" class="text-default">
                    <div class="pt-3 pb10 text-center">
                        <div>
