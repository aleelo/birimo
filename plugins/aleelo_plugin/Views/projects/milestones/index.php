    ...
    <div class="tab-title clearfix">
        ...
        <div class="title-button-group">
            ...
            if ($can_create_milestones) {
                echo modal_anchor(get_uri("project/milestone_modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_milestone'), array("class" => "btn btn-default", "title" => app_lang('add_milestone'), "data-post-project_id" => $project_id));
            }
            ?> 
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#milestone-table").appTable({
            source: '<?php echo_uri("project/milestones_list_data/" . $project_id) ?>',
            order: [[0, "dasc"]],
            columns: [
