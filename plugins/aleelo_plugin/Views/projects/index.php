        ...
        <div class="page-title clearfix projects-page">
            ...
            <div class="title-button-group">
                ...
                if ($can_create_projects) {
                    ...
                    echo modal_anchor(get_uri("project/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_project'), array("class" => "btn btn-default", "title" => app_lang('add_project')));
                }
                ?>
            </div>
        </div>
...
<?php } ?>
        ...
        $("#project-table").appTable({
            source: '<?php echo_uri("project/list_data") ?>',
