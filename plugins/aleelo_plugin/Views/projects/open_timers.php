        ...
        <div  class="list-group-item"> 
            <div class="clearfix">
                ...
                <span class="float-end"><?php
                    echo modal_anchor(get_uri("project/stop_timer_modal_form/" . $timer->project_id), "<i data-feather='clock' class='icon-16'></i> " . app_lang('stop_timer'), array("class" => "btn btn-danger btn-sm", "title" => app_lang('stop_timer'), "data-post-task_id" => $timer->task_id));
                    ?>
                </span>
            </div>
            <?php if (!$timer->task_id) { ?>
                <div class="pt5"> <i data-feather='grid' class='icon-16'></i> <?php echo anchor("project/view/" . $timer->project_id, $timer->project_title, array("class" => "dark")); ?></div>
            <?php } else { ?>
