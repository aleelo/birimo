<div class="card">
    <ul id="project-files-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
        ...
        <?php if ($login_user->user_type === "staff") { ?>
            <li class="nav-item"><a class="nav-link" role="presentation" href="<?php echo_uri("project/file_category/$project_id"); ?>" data-bs-target="#files-category"><?php echo app_lang('category'); ?></a></li>
        <?php } ?>
        ...
        <div class="tab-title clearfix no-border">
            <div class="title-button-group">
                ...
                <?php
                if ($can_add_files) {
                    echo modal_anchor(get_uri("project/file_modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_files'), array("class" => "btn btn-default", "title" => app_lang('add_files'), "data-post-project_id" => $project_id, "id" => "file_or_category_add_button"));
                }
                ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('body').on('click', '[data-act=download-multiple-file-checkbox]', function () {
            ...
            $("#download-multiple-file-btn").attr("href", "<?php echo_uri("project/download_multiple_files/"); ?>" + serializeOfArray);
            $("#delete-multiple-file-btn").attr("href", "<?php echo_uri("project/delete_multiple_files/"); ?>" + serializeOfArray);
        ...
        $("#select-un-select-all-file-btn").click(function () {
            ...
            $("[data-act=download-multiple-file-checkbox]").find("span").removeClass("checkbox-checked");
            $("#download-multiple-file-btn").attr("href", "<?php echo_uri("project/download_multiple_files/"); ?>");
            fields = [];
        ...
        $("#project-file-table").appTable({
            source: '<?php echo_uri("project/files_list_data/" . $project_id) ?>',
            order: [[0, "desc"]],
            filterDropdown: [
...
<?php echo $custom_field_headers; ?>,
        ...
        $(".nav-tabs li").click(function () {
            ...
            if (activeField === "#files") {
                ...
                addButton.attr("data-action-url", "<?php echo get_uri("project/file_modal_form"); ?>");
                ...
                addButton.attr("data-action-url", "<?php echo get_uri("project/file_category_modal_form"); ?>");
