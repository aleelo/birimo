        ...
        <div class="scrollable-page">
            <div class="form-signin">
                ...
                if (isset($form_type) && $form_type == "request_reset_password") {
                    echo view("aleelo_plugin\Views/signin/reset_password_form");
                } else if (isset($form_type) && $form_type == "new_password") {
                    echo view('aleelo_plugin\Views/signin/new_password_form');
                } else {
                    echo view("aleelo_plugin\Views/signin/signin_form");
                }
                ?>
            </div>
        </div>
