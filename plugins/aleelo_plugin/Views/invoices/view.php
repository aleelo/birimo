                ...
                <div class="invoice-title-section">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <?php if ($can_edit_invoices && $invoice_info->type == "invoice") { ?>
                                        ...
                                        <?php if ($invoice_status == "draft" && $invoice_status !== "cancelled") { ?>
                                            <li role="presentation"><?php echo ajax_anchor(get_uri("invoices/update_invoice_status/" . $invoice_info->id . "/not_paid"), "<i data-feather='check' class='icon-16'></i> " . app_lang('mark_invoice_as_confirm'), array("data-reload-on-success" => "1", "class" => "dropdown-item")); ?> </li>
                    ...
                    <ul id="invoice-tabs" data-bs-toggle="ajax-tab" class="nav nav-pills rounded classic mb20 scrollable-tabs border-white" role="tablist">
                        ...
                        <?php //if($invoice_items[0]->supplier){?>
                            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("invoice_payments/supplier_payments/" . $invoice_info->id  ); ?>" data-bs-target="#invoice-payments-supplier"><?php echo app_lang('supplier_payments'); ?></a></li>
