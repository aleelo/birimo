            ...
            <div class="tab-title clearfix no-border invoices-view">
                <div class="title-button-group">
                    <?php if ($can_edit_invoices) { ?>
                        ...
                        <?php if ($can_edit_invoices) { ?>
                        <?php
                        echo modal_anchor(get_uri("invoices/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_invoice'), array("class" => "btn btn-default mb0", "title" => app_lang('add_invoice'))); ?>
                    <?php } ?>
                </div>
            </div>
        </ul>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var invoice_statuses_dropdown = <?php echo view("aleelo_plugin\Views/invoices/invoice_statuses_dropdown"); ?>;
        if (status !== "") {
