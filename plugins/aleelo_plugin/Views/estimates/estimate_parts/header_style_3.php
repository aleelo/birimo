<table class="header-style" style="font-size: 13.5px;">
    <tr class="invoice-preview-header-row">
        <td class="invoice-info-container" style="width: 40%; vertical-align: top;"><?php
            ...
            echo view('aleelo_plugin\Views/estimates/estimate_parts/estimate_from', $data);
            ?>
        </td>
        <td class="hidden-invoice-preview-row" style="width: 20%;"></td>
        <td style="width: 40%; vertical-align: top; text-align: right;">
            <?php echo view('aleelo_plugin\Views/estimates/estimate_parts/estimate_info', $data); ?>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td><?php
            echo view('aleelo_plugin\Views/estimates/estimate_parts/estimate_to', $data);
            ?>
        </td>
        <td></td>
        <td></td>
