...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#estimates-table").appTable({
            ...
            filterDropdown: [{name: "status", class: "w150", options: <?php echo view("aleelo_plugin\Views/estimates/estimate_statuses_dropdown"); ?>}, <?php echo $custom_field_filters; ?>
 ...
 { ?>
            ...
            columns: [
                ...
                {title: "<?php echo app_lang("valid_until") ?>", "iDataSort": 2, "class": "w20p"},
