    ...
    $(document).ready(function() {
        ...
        $("#estimates-table").appTable({
            ...
            filterDropdown: [{
                    name: "status",
                    class: "w150",
                    options: <?php echo view("aleelo_plugin\Views/estimates/estimate_statuses_dropdown"); ?>
                }, <?php echo $custom_field_filters; ?>

                <?php if ((get_array_value($login_user->permissions, "company") === "all") && $login_user->department == "0") { ?> {
                        name: "can_view_all_invoice",
                        class: "w200 ",
                        options: <?php echo $company; ?>
                    }

                <?php  }  ?>
            ],
            columns: [{
                    title: "<?php echo app_lang("estimate") ?> ",
                ...
                {
                    title: "<?php echo app_lang("estimate_date") ?>",
                    "iDataSort": 2,
                    "class": "w20p"
                },
                {
