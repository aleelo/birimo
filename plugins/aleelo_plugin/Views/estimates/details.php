                        ...
                        <div>
                            ...
                            <div class="clearfix">
                                ...
                                <div class="float-end pr15" id="estimate-total-section">
                                    <?php echo view("aleelo_plugin\Views/estimates/estimate_total_section", array("is_estimate_editable" => $is_estimate_editable)); ?>
                                </div>
                            </div>
                            ...
                            if (get_setting("enable_comments_on_estimates") && !($estimate_info->status === "draft")) {
                                echo view("aleelo_plugin\Views/estimates/comment_form");
                            }
                            ?>
            ...
            <div class="card p20">
                <div class="card-body">
                    <div id="estimate-status-bar">
                        <?php echo view("aleelo_plugin\Views/estimates/estimate_status_bar"); ?>
                    </div>
                </div>
            </div>
