<div class="card bg-white">
    ...
    <div class="card-body pt0 rounded-bottom" id="projects-container">
        <ul class="list-group list-group-flush">
            <a class="client-widget-link" data-filter="has_open_projects" href="<?php echo get_uri("client/index/clients_list#has_open_projects"); ?>">
            ...
            <a class="client-widget-link" data-filter="has_completed_projects" href="<?php echo get_uri("client/index/clients_list#has_completed_projects"); ?>">
            ...
            <a class="client-widget-link" data-filter="has_any_hold_projects" href="<?php echo get_uri("client/index/clients_list#has_any_hold_projects"); ?>">
                <li class="list-group-item border-top text-default">
            ...
            <a class="client-widget-link" data-filter="has_canceled_projects" href="<?php echo get_uri("client/index/clients_list#has_canceled_projects"); ?>">
                <li class="list-group-item border-top text-default">
