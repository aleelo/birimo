<div class="card bg-white">
    ...
    <div class="card-body pt0 rounded-bottom" id="proposals-widget-container">
        <ul class="list-group list-group-flush">
            <a class="client-widget-link" data-filter="has_open_proposals" href="<?php echo get_uri("client/index/clients_list#has_open_proposals"); ?>">
            ...
            <a class="client-widget-link" data-filter="has_accepted_proposals" href="<?php echo get_uri("client/index/clients_list#has_accepted_proposals"); ?>">
            ...
            <a class="client-widget-link" data-filter="has_rejected_proposals" href="<?php echo get_uri("client/index/clients_list#has_rejected_proposals"); ?>">
                <li class="list-group-item border-top text-default">
