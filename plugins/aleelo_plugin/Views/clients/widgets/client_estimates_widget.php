<div class="card bg-white">
    ...
    <div class="card-body pt0 rounded-bottom" id="estiamte-widget-container">
        <ul class="list-group list-group-flush">
            <a class="client-widget-link" data-filter="has_open_estimates" href="<?php echo get_uri("client/index/clients_list#has_open_estimates"); ?>">
            ...
            <a class="client-widget-link" data-filter="has_accepted_estimates" href="<?php echo get_uri("client/index/clients_list#has_accepted_estimates"); ?>">
            ...
            <a class="client-widget-link" data-filter="has_new_estimate_requests" href="<?php echo get_uri("client/index/clients_list#has_new_estimate_requests"); ?>">
                <li class="list-group-item border-top text-default">
            ...
            <a class="client-widget-link" data-filter="has_estimate_requests_in_progress" href="<?php echo get_uri("client/index/clients_list#has_estimate_requests_in_progress"); ?>">
                <li class="list-group-item border-top text-default">
