<div class="tab-content">
    ...
    echo form_open(get_uri("client/save_my_preferences"), array("id" => "my-preferences-form", "class" => "general-form dashed-row white", "role" => "form"));
    ?>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class=" col-md-4">
                        ...
                        echo modal_anchor(get_uri("client/keyboard_shortcut_modal_form"), "<i data-feather='info' class='icon-16'></i>", array("class" => "btn btn-default keyboard-shortcut-info-icon ms-3", "title" => app_lang('keyboard_shortcuts_info'), "data-post-user_id" => $login_user->id));
                        ?>
                    </div>
                </div>
            </div>
