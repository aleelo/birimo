<div class="tab-content">
    <?php echo form_open(get_uri("client/save_contact_permissions/" . $user_info->id), array("id" => "contact-permissions-form", "class" => "general-form dashed-row white", "role" => "form")); ?>
    <div class="card border-top-0 rounded-top-0">
        ...
        <div class="card-body">
            ...
            <?php echo view("aleelo_plugin\Views/clients/contacts/contact_permission_fields"); ?>
        </div>
