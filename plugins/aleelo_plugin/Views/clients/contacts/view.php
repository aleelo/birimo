...
<div id="page-content" class="page-wrapper clearfix">
                ...
                <div class="col-md-6">
                    <div class="p20 row">
                        <?php if ($client_info->type != "person") { ?>
                            <p> 
                                <?php
                                $client_link = anchor(get_uri("client/view/" . $client_info->id), $client_info->company_name, array("class" => "white-link"));

                                if ($login_user->user_type === "client") {
                                    $client_link = anchor(get_uri("client/contact_profile/" . $login_user->id . "/company"), $client_info->company_name, array("class" => "white-link"));
                                }
    ...
    <ul id="client-contact-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs b-b rounded-0 border-top-0" role="tablist">
        <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("client/contact_general_info_tab/" . $user_info->id); ?>" data-bs-target="#tab-general-info"> <?php echo app_lang('general_info'); ?></a></li>
        <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("client/company_info_tab/" . $user_info->client_id); ?>" data-bs-target="#tab-company-info"> <?php echo ($client_info->type == "person") ? app_lang('contact_info') : app_lang('company'); ?></a></li>
        <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("client/contact_social_links_tab/" . $user_info->id); ?>" data-bs-target="#tab-social-links"> <?php echo app_lang('social_links'); ?></a></li>
        <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("client/account_settings/" . $user_info->id); ?>" data-bs-target="#tab-account-settings"> <?php echo app_lang('account_settings'); ?></a></li>
        <?php if ($user_info->id == $login_user->id) { ?>
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("client/my_preferences/" . $user_info->id); ?>" data-bs-target="#tab-my-preferences"> <?php echo app_lang('my_preferences'); ?></a></li>
        <?php } ?>
        ...
        <?php if ($user_info->id == $login_user->id && get_setting("enable_gdpr") && (get_setting("clients_can_request_account_removal") || get_setting("allow_clients_to_export_their_data"))) { ?>
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("client/gdpr/" . $user_info->id); ?>" data-bs-target="#tab-gdpr">GDPR</a></li>
        <?php } ?>
        <?php if ($can_edit_clients) { ?>
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("client/contact_permissions/" . $user_info->id); ?>" data-bs-target="#tab-contact-permissions"> <?php echo app_lang('permissions'); ?></a></li>
        <?php } ?>
