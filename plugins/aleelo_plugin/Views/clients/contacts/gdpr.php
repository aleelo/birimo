            ...
            <?php if (get_setting("allow_clients_to_export_their_data")) { ?>
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class=" col-md-10">
                            <?php echo anchor(get_uri("client/export_my_data/"), app_lang("export"), array("class" => "btn btn-primary", "title" => app_lang('export_my_data'))); ?>
                        </div>
                    </div>
                </div>
            <?php } ?>
                    ...
                    <div class="row">
                        ...
                        <div class=" col-md-10">
                            <?php if ($user_info->requested_account_removal) { ?>
                                ...
                                echo anchor(get_uri("client/request_my_account_removal/"), app_lang("apply"), array("class" => "btn btn-danger", "title" => app_lang('i_want_to_remove_my_account')));
                            }
                            ?>
                        </div>
                    </div>
