            ...
            <div class="page-title clearfix">
                ...
                <div class="title-button-group clients-project-page-title">
                    ...
                    if (isset($can_create_projects) && $can_create_projects) {
                        echo modal_anchor(get_uri("project/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_project'), array("class" => "btn btn-default", "data-post-client_id" => $client_id, "title" => app_lang('add_project')));
                    }
                    ?>
                </div>
            </div>
...
?>" || 0;
        ...
        $("#project-table").appTable({
            source: '<?php echo_uri("project/projects_list_data_of_client/" . $client_id) ?>',
            order: [[0, "desc"]],
            hideTools: hideTools,
            multiSelect: [
                {
