<?php echo form_open(get_uri("client/save_client_from_excel_file"), array("id" => "import-client-form", "class" => "general-form", "role" => "form")); ?>
    ...
    <div class="container-fluid">
        <div id="upload-area">
            ...
            echo view("includes/multi_file_uploader", array(
                ...
                "validation_url" => get_uri("client/validate_import_clients_file"),
                "max_files" => 1,
...
<div class="modal-footer">
    <?php echo anchor("client/download_sample_excel_file", "<i data-feather='download' class='icon-16'></i> " . app_lang("download_sample_file"), array("title" => app_lang("download_sample_file"), "class" => "btn btn-default float-start")); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $nextButton.click(function () {
            ...
            $.ajax({
                url: "<?php echo get_uri('client/validate_import_clients_file_data') ?>",
                type: 'POST',
                dataType: 'json',
