    ...
    <?php if ($show_invoice_info) { ?>
        <?php if ($show_project_info) { ?>
            <div class="col-md-3 col-sm-6 widget-container">
                <?php echo view("aleelo_plugin\Views/clients/info_widgets/tab", array("tab" => "projects")); ?>
            </div>
        <?php } ?>

        <?php if ($show_invoice_info) { ?>
            <div class="col-md-3 col-sm-6  widget-container">
                <?php echo view("aleelo_plugin\Views/clients/info_widgets/tab", array("tab" => "total_invoiced")); ?>
            </div>
        <?php } ?>

        <?php if (isset($show_payment_info) && $show_payment_info) { ?>
            <div class="col-md-3 col-sm-6  widget-container">
                <?php echo view("aleelo_plugin\Views/clients/info_widgets/tab", array("tab" => "payments")); ?>
            </div>
            <div class="col-md-3 col-sm-6  widget-container">
                <?php echo view("aleelo_plugin\Views/clients/info_widgets/tab", array("tab" => "due")); ?>
            </div>
        <?php } ?>
