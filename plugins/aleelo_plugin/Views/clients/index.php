<div id="page-content" class="page-wrapper clearfix">
    <div class="clearfix grid-button">
        <ul id="client-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
            ...
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("client/clients_list/"); ?>" data-bs-target="#clients_list"><?php echo app_lang('clients'); ?></a></li>
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("client/contacts/"); ?>" data-bs-target="#contacts"><?php echo app_lang('contacts'); ?></a></li>
            <div class="tab-title clearfix no-border">
                <div class="title-button-group">
                    ...
                    if ($can_edit_clients) {
                        ...
                        echo modal_anchor(get_uri("client/import_clients_modal_form"), "<i data-feather='upload' class='icon-16'></i> " . app_lang('import_clients'), array("class" => "btn btn-default", "title" => app_lang('import_clients'), "id" => "import-btn"));
                        echo modal_anchor(get_uri("client/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_client'), array("class" => "btn btn-default", "title" => app_lang('add_client')));
                    }
                    ?>
                </div>
            </div>
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane fade" id="overview">
                <?php echo view("aleelo_plugin\Views/clients/overview/index"); ?>
            </div>
    ...
    $(document).ready(function () {
        ...
        $(".nav-tabs li").click(function () {
            ...
            if (activeField === "#contacts") {
                ...
                importButton.attr("data-action-url", "<?php echo get_uri("client/import_clients_modal_form"); ?>");
