...
if ($login_user->user_type == "staff") {
    ...
    if ($login_user->is_admin || $access_client) {
        ...
        <li class="nav-item dropdown hidden-xs">
            <?php echo ajax_anchor(get_uri("client/show_my_starred_clients/"), "<i data-feather='briefcase' class='icon'></i>", array("class" => "nav-link dropdown-toggle", "data-bs-toggle" => "dropdown", "data-real-target" => "#clients-quick-list-container")); ?>
