<div class="card rounded-top-0">
    <div class="tab-title clearfix">
        ...
        <div class="title-button-group">
            <?php echo modal_anchor(get_uri("expense/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i>" . app_lang('add_expense'), array("class" => "btn btn-default", "data-post-client_id" => $client_id, "title" => app_lang('add_expense'))); ?>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#expense-table").appTable({
            source: '<?php echo_uri("expense/expense_list_data_of_client/" . $client_id) ?>',
            order: [[0, "desc"]],
