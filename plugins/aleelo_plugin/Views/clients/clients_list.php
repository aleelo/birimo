...
<script type="text/javascript">
    loadClientsTable = function(selector) {
        ...
        var quick_filters_dropdown = <?php echo view("aleelo_plugin\Views/clients/quick_filters_dropdown"); ?>;
        ...
        $(selector).appTable({
            source: '<?php echo_uri("client/list_data") ?>',
            serverSide: true,
            ...
            filterDropdown: [{
                ...
                <?php if ($see_company_dropdown) { ?> {
                        name: "company_id",
                        class: "w200",
                        options: <?php echo $companies_dropdown; ?>
                    },
                <?php } ?>
            ...
            columns: [{
                ...
                {
                    title: "<?php echo app_lang("clients") ?>",
                    "class": "all",
