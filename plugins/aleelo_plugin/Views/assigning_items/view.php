                ...
                <div class="page-title clearfix no-border no-border-top-radius no-bg">
                    <h1 class="pl0">
                        ...
                        <span id="star-mark">
                            <?php
                            if ($is_starred) {
                                echo view('aleelo_plugin\Views/assigning_items/star/starred', array("client_id" => $department_info->id));
                            } else {
                                echo view('aleelo_plugin\Views/assigning_items/star/not_starred', array("client_id" => $department_info->id));
                            }
                            ?>
                        </span>
