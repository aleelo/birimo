<div id="page-content" class="page-wrapper clearfix grid-button all-tasks-view">
    ...
    <ul class="nav nav-tabs bg-white title" role="tablist">
        ...
        <?php echo view("aleelo_plugin\Views/tasks/tabs", array("active_tab" => "tasks_list", "selected_tab" => $tab)); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#task-table").appTable({
            ...
            filterDropdown: [
                {name: "quick_filter", class: "w200", showHtml: true, options: <?php echo view("aleelo_plugin\Views/tasks/quick_filters_dropdown"); ?>},
 ...
 { ?>
           , {name: "all_tasks", class: "w200 ", options: <?php echo $company; ?>}
...
<?php echo view("aleelo_plugin\Views/tasks/batch_update/batch_update_script"); ?>
<?php echo view("aleelo_plugin\Views/tasks/task_table_common_script"); ?>
<?php echo view("aleelo_plugin\Views/tasks/update_task_read_comments_status_script"); ?>
<?php echo view("aleelo_plugin\Views/tasks/quick_filters_helper_js"); ?>