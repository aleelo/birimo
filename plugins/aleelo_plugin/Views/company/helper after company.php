...
if (!function_exists("get_logo_url")) {
    ...
    function get_logo_url($department_id) {
        return get_file_from_setting($department_id);
    }
}
...
if (!function_exists("get_file_from_setting")) {
    ...
    function get_file_from_setting($department_id = "", $only_file_path_with_slash = false, $file_path = "", $company_id = null) {
        if ($department_id) {
