...
use CodeIgniter\Model;
 ...
 class Expense_payments_emp_model extends Crud_model
{
    function __construct() {
        $this->table = 'expense_payments_emp'; // ✅ fixed
    ...
    function get_details($options = []) {
        ...
        WHERE $expense_payments_table.deleted=0 AND $expenses_table.deleted=0 $where";
