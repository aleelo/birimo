...
class Users_models extends Crud_model {
    ...
    function get_details($options = array()) {
       ...
       $can_view_all_members = $this->_get_clean_value($options, "can_view_all_members");
        ...
        $team_member_job_info_table.date_of_hire, $team_member_job_info_table.salary, $team_member_job_info_table.salary_term,$team_member_job_info_table.company_id
    FROM $users_table
