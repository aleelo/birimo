...
foreach ($activity_logs as $log) {
    ...
    if (
        ...
        $log->action === "updated" ||
        $log->action === "deleted" ||
        $log->action === "bitbucket_notification_received" ||
        $log->action === "github_notification_received" ||
        $log->action === "sent" ||
        $log->action === "accepted" ||
        $log->action === "declined" ||
        $log->action === "not_paid" ||
            ...
            <div class="p-2 w-100">
                ...
                <p>
                    ...
                    if ($log->action === "created") {
                        ...
                        $label_class = "info";        // blue
                    } else if ($log->action === "accepted") {
                        $label_class = "success";     // green
                    } else if ($log->action === "declined") {
                        $label_class = "danger";      // red
                    } else if ($log->action === "not_paid") {
                        $label_class = "warning";        // dark grey
                    } else if ($log->action === "cancelled") {
                        $label_class = "danger";   // light grey
                    } else if ($log->action === "credited") {
                        $label_class = "primary";     // blue/purple primary
                    } else if ($log->action === "restored") {
                        $label_class = "warning";     // blue/purple primary
                    }
