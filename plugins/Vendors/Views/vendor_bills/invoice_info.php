<div class="card" id="invoice-details-invoice-info">
                    ...
                    <?php if ($can_edit_invoices && $invoice_info->type == "invoice") { ?>
                        ...
                        <li role="presentation">
                            <?php echo modal_anchor(
                                get_uri("invoices/add_signature_modal_form/" . $invoice_info->id),
                                "<i data-feather='edit-2' class='icon-16'></i> " . ('Add Signature'),
                                array("title" => ("add signature"), "data-post-id" => $invoice_info->id, "class" => "dropdown-item")
                            ); ?>
                        </li>
    ...
    <div class="card-body">
        <ul class="list-group info-list">
            <?php if ($can_hide_clients && $invoice_info->client_id) { ?>
            ...
            <?php }  else { ?>
                    <span title="<?php echo app_lang("client"); ?>"><i data-feather="briefcase" class="icon-16 mr5"></i> <?php echo $invoice_info->company_name ?></span>
                <?php } ?>

            <?php if ($can_hide_projects && $invoice_info->project_id) { ?>
            ...
            <?php } else { ?>
                    <span title="<?php echo app_lang("client"); ?>"><i data-feather="briefcase" class="icon-16 mr5"></i> <?php echo $invoice_info->project_title ?></span>
                <?php } ?>
