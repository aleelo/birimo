        ...
        <div class="title-button-group mr0">
            ...
            <span class="dropdown inline-block">
                <?php if ($invoice_status == "draft" && $invoice_status !== "cancelled" && $can_edit_invoices) { ?>
                    <?php echo ajax_anchor(get_uri("invoices/update_invoice_status/" . $invoice_info->id . "/not_paid"), "<i data-feather='check' class='icon-16'></i> " . app_lang('mark_invoice_as_not_paid_'), array("data-inline-loader" => "1", "class" => "btn btn-warning text-white spinning-btn mr0 ml10", "data-request-group" => "invoice_status")); ?>
                <?php } ?>
            </span>
        </div>
    </div>
