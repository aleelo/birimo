                ...
                foreach ($payment_methods as $payment_method) {
                    ...
                    if ($invoice_total_summary->balance_due >= get_array_value($payment_method, "minimum_payment_amount")) {
                        if ($method_type == "stripe") {
                            echo view("Sales_and_crm\Views/invoices/_stripe_payment_form", $pass_variables);
                        } else if ($method_type == "paypal_payments_standard") {
                            echo view("Sales_and_crm\Views/invoices/_paypal_payments_standard_form", $pass_variables);
                        } else if ($method_type == "paytm") {
                            echo view("Sales_and_crm\Views/invoices/_paytm_payment_form", $pass_variables);
                        }
