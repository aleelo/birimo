            ...
            foreach ($invoice_items as $item) { ?>
                ...
                ?>
                    ...
                    <tr style="background-color:<?php echo get_setting("invoice_item_list_background") ?>;">
                        ...
                        <td style="width: <?php echo $show_taxable ? '40%' : '50%'; ?>;"><?php echo $item->title ?></td>
            ...
            <td style="width: 40%; text-align: center;">
                ...
                <div class="signature-block" style="margin-top: 10px;">
                    <?php if (!empty($finance_manager_user_info->first_name)) { ?>
                        <h5 class="signature-name" style="color: <?php echo $color ?>;">
                            <?php echo $finance_manager_user_info->first_name . ' ' . $finance_manager_user_info->last_name; ?>
                        </h5>
                    <?php } ?>
                    <?php if (!empty($finance_manager_job_info->job_title_en)) { ?>
                        <h5 class="signature-title"><?php echo $finance_manager_user_info->job_title; ?></h5>
                    <?php } ?>
                </div>
            </td>
