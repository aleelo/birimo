...
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <div class="form-group">
            <div class="row">
                <label for="supplier" class=" col-md-3 col-xs-5 col-sm-4"><?php echo ('from Vendor'); ?></label>
                <div class=" col-md-9 col-xs-7 col-sm-8">
                    <?php
        ...
        <div id="cheked" class="hide">
            <div class="form-group">
                <div class="row">
                    <label for="company_id" class="col-md-3"><?php echo 'Vendor'; ?></label>
                    <div class="col-md-9">
                        <?php
                        ...
                        ), $supplier_dropdown, [$model_info->supplier_id]);
                        ?>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="row">
                    <label for="supplier_price" class=" col-md-3"><?php echo ('Vendor price'); ?></label>
                    <div class="col-md-9">
                        <?php
                        echo form_input(array(
                            "id" => "supplier_price",
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#invoice-item-form").appForm({
            onSuccess: function(result) {
                const $tbl = $("#invoice-item-table");

                // if backend returns the rendered row, append it
                ...
                // force the grid to keep ascending order so the new row goes to the bottom
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response && response.success) {
                            ...
                            // $("#supplier_price").val(response.item_info.supplier_price);
