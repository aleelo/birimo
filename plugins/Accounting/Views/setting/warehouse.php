<?php 
  ...
  $acc_wh_stock_export_profit_payment_account = get_setting('acc_wh_stock_export_profit_payment_account');
  $acc_wh_stock_export_profit_deposit_to = get_setting('acc_wh_stock_export_profit_deposit_to');
