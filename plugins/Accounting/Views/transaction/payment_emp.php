...
<table class="table table-invoices">
   <thead>
      <th><span class="hide"> - </span>
         <div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="invoices" class="form-check-input"><label></label></div>
      </th>
...
<?php require 'plugins/Accounting/assets/js/transaction/payment_emp_js.php'; ?>