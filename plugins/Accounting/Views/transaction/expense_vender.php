<div class="card">
    <div class="clearfix">
        <ul id="transaction-sale-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs rounded classic mb20 scrollable-tabs" role="tablist">
            ...
            <li>
                <a role="presentation" data-bs-toggle="tab" data-bs-toggle="tab" href="<?php echo get_uri('accounting/transaction?group=sales&tab=expenses'); ?>" data-bs-target="#transaction_payments"><?php echo app_lang('expense'); ?> <span class="text-danger"><?php echo '('.$count_expense.')'; ?></span></a></li>
