<div id="page-content" class="page-wrapper clearfix">
    <?php echo acc_form_hidden('site_url', get_uri()); ?>
    <div class="card">
        ...
        <div class="card-body">
          ...
          <?php echo form_open(get_uri('accounting/finish_reconcile_account'),array('id'=>'reconcile-account-form','autocomplete'=>'off')); ?>
            ...
            <?php echo acc_form_hidden('history_ids'); ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <?php echo acc_form_hidden('adjustment_amount'); ?>
        <?php echo acc_form_hidden('account', $account->id); ?>
        <?php echo acc_form_hidden('reconcile', $reconcile->id); ?>
        <?php echo acc_form_hidden('finish', 1); ?>
        <?php echo acc_form_hidden('history_ids'); ?>
