  ...
  <div class="card">
    ...
    <div class="card-body">
        ...
        <div class="col-md-10">
          ...
          <div class="row">
            ...
            ?>
              <!-- <div class="col-md-3">
                <div class="form-group">
                  <label for="company_id"><?php echo ('company name'); ?></label>
                  <?php
                //  echo form_dropdown("company_filter", $company_dropdown, '', "class='form-control select2' id='company_id'");
                  ?>
                </div>
              </div> -->
            <?php //} ?>
            <div class="col-md-3">
              <div class="form-group">
                <label for="client" class=""><?php echo app_lang('supplier'); ?> </label>
                <?php
                echo form_dropdown("supplier_id", $supplier, array($accounting_method), "class='select2 validate-hidden' id='supplier_id'");
                ?>
              </div>
            </div>

            <div class="col-md-3 mt-1">
              <?php echo form_hidden('type', 'accounts_receivable_ageing_supplier_detail'); ?>
      ...
      <div class="report-content">
        <div class="page1" id="DivIdToPrint">
        </div>
      </div>
    </div>
  </div>
