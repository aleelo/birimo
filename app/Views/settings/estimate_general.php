<?php echo form_open(get_uri("settings/save_estimate_general_settings"), array("id" => "invoice-general-settings-form", "class" => "general-form dashed-row", "role" => "form")); ?>

<div class="card-body">
    <div class="form-group">
        <div class="row">
            <label for="default_due_date_after_estimate_date" class="col-md-2"><?php echo app_lang('default_due_date_after_estimate_date'); ?></label>
            <div class="col-md-3">
                <?php
                echo form_input(array(
                    "id" => "default_due_date_after_estimate_date",
                    "name" => "default_due_date_after_estimate_date",
                    "type" => "number",
                    "value" => get_setting("default_due_date_after_estimate_date"),
